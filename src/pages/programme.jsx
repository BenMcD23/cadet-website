            ...
            <div className="bg-dark-blue-main title-hover text-center pb-2 lg:pt-14">
                ...
                <div className="flex items-center justify-center">
                    <div className="text-center m-auto text-3xl lg:text-4xl font-semibold">
                        <div>
                            <a href="/programme/03_26_programme.pdf" target="_blank" rel="noopener noreferrer" className="programme-svg text-2xl md:text-4xl">

                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-16 sm:size-28 m-auto">
                        ...
                        {/* <p className="text-xl leading-7 lg:text-2xl text-white pb-1 px-8">Unit Stand Down
                                <br/><br/>We are back on 14/01/2025
                                <br/><br/>Have a good Christmas and New Year!
                        </p> */}
                        </div>
                    </div>
                </div>
