...
function Navbar() {
	...
	return (
		...
		<nav className="grid grid-cols-5 lg:grid-cols-9 xl:grid-cols-11 navbar-container pt-1 pb-1.5">
				<NavLink to="/" className="absolute hidden bg-transparent lg:block m-auto lg:col-start-2 xl:col-start-3"><img src={nav_logo} style={{height: "64px", width:"auto"}}/></NavLink>
					
				<NavLink to="/" className="lg:col-start-4 xl:col-start-5 lg:rounded-l-xl lg:py-4">
					...
					<p className="text-center text-sm lg:text-xl font-semibold leading-none">Home</p>
				</NavLink>
				<NavLink to="/programme" className="lg:py-4">
					<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-8 md:size-10 m-auto block lg:hidden">
					<path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5" />
					</svg>
					<p className="text-center text-sm lg:text-xl font-semibold leading-none">Programme</p>
				</NavLink>
				<div className={`relative dropdown lg:py-4 ${aboutActive ? 'active' : ''}`}>
					...
					<p className="text-center text-sm lg:text-xl font-semibold leading-none">About</p>
				...
				<div className={`relative dropdown lg:py-4 ${resourcesActive ? 'active' : ''}`}>
					...
					<p className="text-center text-sm lg:text-xl font-semibold leading-none">Resources</p>
					<div className="dropdown-content">
				...
				<NavLink to="/join" className="lg:rounded-r-xl lg:py-4">
					<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-8 md:size-10 m-auto block lg:hidden">
					<path strokeLinecap="round" strokeLinejoin="round" d="M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0ZM3 19.235v-.11a6.375 6.375 0 0 1 12.75 0v.109A12.318 12.318 0 0 1 9.374 21c-2.331 0-4.512-.645-6.374-1.766Z" />
					</svg>
					<p className="text-center text-sm lg:text-xl font-semibold leading-none">Join</p>
				</NavLink>
			</nav>
