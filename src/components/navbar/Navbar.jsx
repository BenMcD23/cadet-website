	...
	return (
		...
		<NavLink to="/" className="hidden lg:block m-auto lg:col-start-2"><img src={nav_logo} style={{height: "64px", width:"auto"}}/></NavLink>
				...
				<NavLink to="/" className="lg:col-start-4">
					<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8 md:size-10 m-auto">
					<path stroke-linecap="round" stroke-linejoin="round" d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
					</svg>
					<p className="text-center text-sm font-semibold leading-none tracking-tight lg:text-base">Home</p>
				</NavLink>
				<NavLink to="/programme" className="">
					<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8 md:size-10 m-auto">
				...
				<div className={`relative dropdown ${resourcesActive ? 'active' : ''}`}>
					...
					<p className="text-center text-sm font-semibold leading-none tracking-tight lg:text-base">Resources</p>
					<div className="dropdown-content">
						<NavLink to="/documents" className="text-center text-base font-semibold leading-none tracking-tight lg:text-base">Documents</NavLink>
						<NavLink to="/flight-points" className="text-center text-base font-semibold leading-none tracking-tight lg:text-base">Flight Points</NavLink>
						<NavLink to="/parents" className="text-center text-base font-semibold leading-none tracking-tight lg:text-base">Parents</NavLink>
				...
				<NavLink to="/about">
					...
					<p className="text-center text-sm font-semibold leading-none tracking-tight lg:text-base">Join</p>
				</NavLink>
			</nav>
