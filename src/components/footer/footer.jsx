...
function Footer() {
    ...
    return (
        <footer className="text-center bg-dark-blue dark:text-neutral-200">
            {/* Main container div: holds the entire content of the footer, including four sections (TW Elements, Products, Useful links, and Contact), with responsive styling and appropriate padding/margins. */}
            <div className="mx-6 py-10 text-center md:text-left">
				<div className="grid-1 grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-5"
                    ...
                    <div className="text-left">
                        ...
                        <p className="mb-2">
                            <a className="text-neutral-600 dark:text-neutral-200" href="https://www.raf.mod.uk/aircadets/find-a-squadron/">Find Your Nearest Sqn</a>
                        </p>
                        <p className="mb-2">
							<a className="text-neutral-600 dark:text-neutral-200" href="https://www.raf.mod.uk/aircadets/">Air Cadets Website</a>
                        </p>
                        <p className="mb-2">
                            <a className="text-neutral-600 dark:text-neutral-200" href="https://www.facebook.com/aircadets">Air Cadets Facebook</a>
                        </p>
                        <p className="mb-2">
							<a className="text-neutral-600 dark:text-neutral-200" href="https://x.com/aircadets">Air Cadets X</a>
                        </p>
                    ...
                    <div className="text-left">
						...
						<a className="mr-6 text-neutral-600 dark:text-neutral-200" href="https://www.facebook.com/317atc">
							<p className="mb-2 flex items-center justify-center md:justify-start text-left">
								<svg
						...
						<a className="mr-6 text-neutral-600 dark:text-neutral-200" href="https://www.instagram.com/317_atc/">
							<p className="mb-2 flex items-center justify-center md:justify-start text-left">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								className="mr-3 h-5 w-5"
						...
						<a className="mr-6 text-neutral-600 dark:text-neutral-200" href="https://x.com/317ATC">
							<p className="mb-2 flex items-center justify-center md:justify-start text-left">
								<svg
								xmlns="http://www.w3.org/2000/svg"
								className="mr-3 h-5 w-5"
                    ...
                    <div>
                        ...
                        <p className="mb-4 flex items-center justify-center md:justify-start text-left">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                                fill="currentColor"
