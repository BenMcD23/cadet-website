                ...
                <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4">             
                    ...
                    <div className="lg:text-center md:text-center sm:text-center">
                        ...
                        <div className="mb-2 flex items-center justify-center ">
                            <a className="flex items-center text-neutral-600 dark:text-neutral-200" href="https://www.facebook.com/317atc">
                        ...
                        <div className="mb-2 flex items-center justify-center">
                            <a className="flex items-center text-neutral-600 dark:text-neutral-200" href="https://www.instagram.com/317_atc/">
                        ...
                        <div className="mb-2 flex items-center justify-center">
                            <a className="flex items-center text-neutral-600 dark:text-neutral-200" href="https://x.com/317ATC">
