            ...
            <div className="grid grid-cols-1 md:grid-cols-12 grid-rows-4 gap-1 staff-container">
                ...
                <div className="flex items-center justify-center md:col-start-5 md:col-end-9 md:row-start-1 md:row-end-2">
                    ...
                    <div className="image-text-container text-center">
                        ...
                        <p className="text-xl font-extrabold leading-none tracking-tight lg:text-2xl text-black">Flt Lt Simon Doherty</p>
                    </div>
                </div>
                <div className="flex items-center justify-center md:col-start-5 md:col-end-9 md:row-start-2 md:row-end-3">
                    <div className="image-text-container text-center">
                        ...
                        <p className="text-xl font-extrabold leading-none tracking-tight lg:text-2xl text-black">CI Roy Catterall (Wg Cdr Ret'd)</p>
                    </div>
                </div>
                ...
                <div className="flex items-center justify-center  md:col-start-3 md:col-end-7 md:row-start-3 md:row-end-4">
                    <div className="image-text-container text-center">
                        ...
                        <p className="text-xl font-extrabold leading-none tracking-tight lg:text-2xl text-black">WO Jonathon Barker</p>
                    </div>
                </div>
                ...
                <div className="flex items-center justify-center md:col-start-7 md:col-end-11 md:row-start-3 md:row-end-4">
                    <div className="image-text-container text-center">
                        ...
                        <p className="text-xl font-extrabold leading-none tracking-tight lg:text-2xl text-black">FS Joseph Gill</p>
                    </div>
                </div>
                <div className="flex items-center justify-center md:col-start-1 md:col-end-5 md:row-start-4 md:row-end-5">
                    <div className="image-text-container text-center">
                        ...
                        <p className="text-xl font-extrabold leading-none tracking-tight lg:text-2xl text-black">CI Ben McDonald</p>
                    </div>
                </div>
                ...
                <div className="flex items-center justify-center md:col-start-5 md:col-end-9 md:row-start-4 md:row-end-5">
                    <div className="image-text-container m-auto">
                        ...
                        <p className="text-xl font-extrabold leading-none tracking-tight lg:text-2xl text-black">CI Jacob Gill</p>
                    </div>
                </div>
